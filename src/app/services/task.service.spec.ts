...
describe('TaskService', () => {
  ...
  it('should add a task at the beginning of the task list', () => {
    ...
    const tasks: Task = { name: 'Task 0', id: 0, done: false, edit: false, trash: false, startDate: Date.now() };
  ...
  it('should add a task to the task list', () => {
    const task: Task = { name: 'Task 3', id: 3, done: false, edit: false, trash: false, startDate: Date.now() };
